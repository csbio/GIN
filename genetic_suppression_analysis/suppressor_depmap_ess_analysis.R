...
for (supp_cutoff in supp_cutoff_list)
{
	...
	hap1_ess_non_supp_gene = setdiff(all_hap1_ess_gene,hap1_ess_supp_deg_0_gene)
	...
	output_folder = "./"
	ggsave(file.path(output_folder, paste0("boxplot_fraction_of_esssential_depmap_suppressor_", supp_cutoff, ".pdf")), device = cairo_pdf,height = 15 , width = 10 )
}