...
data_qGI_sub <- data_qGI_sub[which(!(data_qGI_sub$Row_Complex %in% mito_complex | data_qGI_sub$Column_Complex %in% mito_complex)),]

#keep rows with total enrichment<.1
data_qGI_sub <- data_qGI_sub[which(data_qGI_sub$Enrichment_total<.1),]

# save output
write.csv(data_qGI_sub,file.path("./output_library_3_or_query_1_complex/NO_MITO_.5_NO_SUBSET_.3_WB_library_3_or_query_1_complex_subset_5_.1_between_version_2.csv"),row.names = F)
...
# output file
ggsave(file.path('./output_library_3_or_query_1_complex/NO_MITO_.5_NO_SUBSET_.3_WB_library_3_or_query_1_complex_subset_5_.1_between_version_2.pdf'),plot =plot1,height = 14 , width = 14)
...
#save output 
write.csv(data_qGI_sub,file.path("./output_library_3_or_query_1_complex/NO_MITO_.5_NO_SUBSET_.3_WB_library_3_or_query_1_complex_subset_5_.1_within_version_2.csv"),row.names = F)
...
ggsave(file.path('./output_library_3_or_query_1_complex/NO_MITO_.5_NO_SUBSET_.3_WB_library_3_or_query_1_complex_subset_5_.1_within_version_2.pdf'),plot =plot1,height = 14 , width = 14)
