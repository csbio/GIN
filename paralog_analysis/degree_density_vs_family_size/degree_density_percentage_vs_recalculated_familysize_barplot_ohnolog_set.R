...
# packages <- c("reshape2","readxl",'writexl',"ggplot2", "ggthemes",'gridExtra','dplyr','igraph','tidyverse')
# for (p in packages) {
...
ohnolog_sub_ = ohnolog_sub_[,c('Symbol1','Symbol2','family_size')]
ohnolog_sub_2 = ohnolog_sub_[,c('Symbol1','family_size')]
ohnolog_sub_3 = ohnolog_sub_[,c('Symbol2','family_size')]
colnames(ohnolog_sub_3) = c('Symbol1','family_size')
ohnolog_sub_2 = rbind(ohnolog_sub_2,ohnolog_sub_3)
ohnolog_sub_2 = unique(ohnolog_sub_2)


#filter based on screened genes
ohnolog_sub_2 = ohnolog_sub_2[which(ohnolog_sub_2$Symbol1 %in% density_data$gene),]

ohnolog_sub_2$qGI_degree_std_pos = density_data$qGI_degree_std_pos[match(ohnolog_sub_2$Symbol1,density_data$gene)]
ohnolog_sub_2$qGI_degree_std_neg = density_data$qGI_degree_std_neg[match(ohnolog_sub_2$Symbol1,density_data$gene)]
...
ggsave(file.path(output_folder, paste0("ohnolog_degree_density_vs_family_size_barplot_both_exp_open_bin.pdf")), device = cairo_pdf,height = 10 , width = 20 )
