...
# load ensemble paralog gene pair list
...
ggsave(file.path(output_folder, paste0("barplot_id_open_bin_", iden_cutoff, "_neg_0.pdf")), device = cairo_pdf,height = 10 , width = 20 )
