...
class TestEnrichmentHypergeometric(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sf.load_attributes(attribute_file='/Users/zhangxiang/Downloads/Research_CB/GIN/safepy_network_annotation/safe-data/attributes/go_bp_140819.txt.gz')
...
class TestEnrichmentPermutations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # Load the binary attributes
        sf.load_attributes(attribute_file='/Users/zhangxiang/Downloads/Research_CB/GIN/safepy_network_annotation/safe-data/attributes/hoepfner_movva_2014_doxorubucin.txt')
